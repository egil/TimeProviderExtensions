...
#pragma warning disable S3236 // Caller information arguments should not be provided explicitly
            _ = IfOutOfRange(_dueTimeMs, -1, MaxSupportedTimeout, nameof(dueTime));
            _ = IfOutOfRange(_periodMs, -1, MaxSupportedTimeout, nameof(period));
#pragma warning restore S3236 // Caller information arguments should not be provided explicitly
    ...
    public static long IfOutOfRange(long argument, long min, long max, [CallerArgumentExpression(nameof(argument))] string paramName = "")
    {
        ...
        {
            throw new ArgumentOutOfRangeException(paramName, argument, $"Argument not in the range [{min}..{max}]");
        }
