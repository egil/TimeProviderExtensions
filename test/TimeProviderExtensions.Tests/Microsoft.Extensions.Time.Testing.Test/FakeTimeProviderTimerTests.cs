...
public class FakeTimeProviderTimerTests
{
    ...
    [Fact(Skip = "If interval is 10ms and time is advanced with 100, there should be 10 callbacks. That is how the production timer works.")]
    ...
    {
        var fakeTimeProvider = new SutTimeProvider();
    ...
    {
        using var t = new FakeTimeProviderTimer(new SutTimeProvider(), TimeSpan.FromMilliseconds(1), TimeSpan.FromMilliseconds(1), new TimerCallback(EmptyTimerTarget), null);
    ...
    {
        var t = new FakeTimeProviderTimer(new SutTimeProvider(), TimeSpan.FromMilliseconds(1), TimeSpan.FromMilliseconds(1), new TimerCallback(EmptyTimerTarget), null);
